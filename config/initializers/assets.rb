...
%w( landing_pages tdashboard1 tdashboard/base tdashboard/tipsters tdashboard/matches tdashboard/orders dashboard/base dashboard/tipsters monologue/foundation_icons/social_foundicons).each do |controller|
